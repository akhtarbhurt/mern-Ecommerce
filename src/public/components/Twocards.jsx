...
const Twocards = () => {
  return (
    ...
    <>
    <div className=' flex w-full justify-center my-16 lg:my-32'> 
<div className=' w-11/12 flex justify-between  flex-col  lg:flex-row  '>
        <div className=' w-[100%] relative lg:w-[48%] '>
<img className=' h-[50vh] lg:h-[86vh]' src="https://bachatmart.pk/public/images/1718352740-666bfb641f851.jpeg" alt="" />
...
<img className=' h-[50vh] lg:h-[86vh]' src="https://bachatmart.pk/public/images/1718282899-666aea935ece3.jpeg" alt="" />
