...
const Navscrolldown = () => {
      ...
      >
        <div className="w-full flex justify-center">
          <div className="w-11/12">
            <div className="w-11/12 py-2 relative flex justify-between flex-wrap items-center lg:flex-nowrap lg:w-6/12 lg:py-2">
              ...
              {/* <div className="hover:text-green-700 cursor-pointer  text-[10px] lg:text-[14px] font-semibold  lg:m-0">
                <div className=" ml-auto  mr-auto  bg-green-600 text-white text-center rounded-lg w-[45px]   text-[10px] lg:text-[14px]">
                  New
                </div>
 ...
 <Link to={'/product'} className="relative cursor-pointer font-semibold border-b-[3px] border-green-600 text-green-600 p-1 lg:p-2  text-[10px] lg:text-[14px]  rounded-sm   lg:m-0">
               <div className=" absolute rounded-lg top-[-4px] text-[10px] left-4 bg-green-600 text-white px-2">New</div>
               <div>Product</div> 
              </Link>
